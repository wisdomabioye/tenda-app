/**
 * The gig CTA bar's slot vocabulary (moved from
 * apps/mobile/components/gig/gig-cta/types.ts 2026-08-15 — the whole rules +
 * arrangement layer is shared; only the renderers stay per-client).
 */
