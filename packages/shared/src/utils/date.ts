/**
 * Consolidated relative-time formatters used across every client (mobile +
 * web). Single source of truth for "Today / Yesterday / Wednesday / Mar 15"
 * style labels and shorter "2m / 5h / 3d ago" reviews-style labels — moved
 * here from apps/mobile/lib/date.ts so the clients cannot drift.
 */
