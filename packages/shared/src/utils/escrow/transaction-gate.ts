 ...
 * call sites do the toast + navigation, mirroring utils/auth-flow. The route
 * strings are the same paths on mobile (expo-router) and web (Next) — a
 * deliberate cross-client contract, asserted by both apps' navigation.
 */
