...
const dossier: AdminEscrowDossier = {
  ...
  gig: { title: 'Broken delivery', description: null, category: 'errands', country: null, city: null, remote: true, proof_requirements: [], proof_params: null, requires_approval: false, assigned_from_application: false, applicant_count: 0 },
