...
export const FOOTER_LEGAL = {
  ...
  disclaimer:
    'Tenda is a software interface; settlement is executed on-chain by the Solana escrow program. Crypto products may not be available in all regions. Devnet release — not financial advice.',
  links: [
